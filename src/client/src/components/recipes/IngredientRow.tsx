...
function IngredientRow({ index = 1, onRemove }: Props) {
  ...
  return (
    ...
    >
      ...
      <select className="bg-[#333] border border-[#444] rounded text-white text-sm px-1.5 py-0.5 outline-none cursor-pointer">
